...
const PRODUCTS = [
  { icon: Camera, title: "Security System", tag: "CCTV & Alarm", desc: "Instalasi CCTV dan alarm untuk melindungi aset dan usaha Anda.", cover: "dots" },
  { icon: Zap, title: "Electrical Works", tag: "MV & LV", desc: "Panel tegangan menengah/rendah, cubicle, trafo, penangkal petir, PJU, lift, genset.", cover: "waves" },
  { icon: Cpu, title: "Industrial PLC", tag: "Automation", desc: "Pemrograman PLC, Mikrotik, server, otomasi mesin industri & robotika.", cover: "orbit" },
  { icon: Building2, title: "Building Construction", tag: "Design & Build", desc: "Pembangunan baru, renovasi, atap galvalum, interior, eksterior, lighting bangunan.", cover: "iso" },
  { icon: Wrench, title: "Mechanical Plumbing", tag: "MEP", desc: "Pemanas, pendingin, ventilasi, hydran, pipa & fitting, pompa, gas, otomatisasi.", cover: "pipes" },
  { icon: Sun, title: "Solar Power (PLTS)", tag: "Renewable", desc: "Pengembangan, instalasi, operasi & pemeliharaan pembangkit listrik tenaga surya.", cover: "rays" },
  { icon: Truck, title: "Heavy Equipment", tag: "Service", desc: "Servis alat berat: backhoe, tower crane, batching plant, bulldozer, excavator.", cover: "grid" },
  { icon: HardHat, title: "Electronic Service", tag: "Repair & Install", desc: "AC, pompa air, gerbang otomatis, dan perbaikan alat elektronik lainnya.", cover: "cross" },
  { icon: Users, title: "Suppliers & SDM", tag: "Outsourcing", desc: "Penyedia SDM bersertifikasi berikut penyediaan barang dan jasa terkait.", cover: "bars" },
] as const;
...
const SOLUTIONS = [
  {
    ...
    desc: "Sistem kelistrikan, otomasi PLC, pengawasan CCTV, dan penyediaan SDM untuk lantai produksi & gudang.",
    products: ["Electrical Works", "Industrial PLC", "Security System"],
  },
  {
    id: "perbankan",
    icon: Landmark,
    label: "Perbankan",
    desc: "Infrastruktur kelistrikan dan CCTV bertingkat untuk kantor cabang, ruang server, dan area ATM.",
    products: ["Security System", "Electrical Works", "Electronic Service"],
  },
  {
    id: "retail",
    icon: ShoppingBag,
    label: "Retail & F&B",
    desc: "Instalasi CCTV toko, dapur, dan pengaturan kelistrikan untuk gerai dengan operasional harian tinggi.",
    products: ["Security System", "Electronic Service", "Mechanical Plumbing"],
  },
  {
    id: "perhotelan",
    icon: Hotel,
    label: "Perhotelan",
    desc: "MEP, sistem keamanan, dan pengelolaan energi bagi hotel dan properti hospitality.",
    products: ["Mechanical Plumbing", "Security System", "Electrical Works"],
  },
  {
    id: "kantor",
    icon: Building2,
    label: "Perkantoran",
    desc: "Panel LV/MV, PLTS atap, dan pengaturan CCTV untuk gedung perkantoran modern.",
    products: ["Electrical Works", "Solar Power (PLTS)", "Security System"],
  },
  {
    id: "konstruksi",
    icon: HardHat,
    label: "Konstruksi",
    desc: "Dukungan alat berat, tenaga tersertifikasi, dan pekerjaan struktur untuk site konstruksi.",
    products: ["Heavy Equipment", "Building Construction", "Suppliers & SDM"],
  },
];
...
const PROOF = [
  ...
  { icon: Building2, value: "9", label: "Lini Bisnis Utama", desc: "Kelistrikan, CCTV, MEP & SDM" },
